...
const SingUp = () => {
  ...
  const onSubmit = async (data) => {
    ...
    const my = await axios.put(`https://falcon-parts-manufatures.herokuapp.com/user?email=${email}`, {
      name: name,
      email: email,
    });
...
// console.log(gUser)
  useEffect(() => {
    fetch(`https://falcon-parts-manufatures.herokuapp.com/user?email=${gUser?.user?.email}`, {
      method: "PUT",
      body: JSON.stringify({
